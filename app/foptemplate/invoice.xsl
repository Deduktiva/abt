...
<xsl:stylesheet version="2.0"
    ...
    <fo:page-sequence master-reference="psmA" id="document-sequence" font-family="sans-serif" font-weight="400" font-size="11pt" line-height="12pt">
            ...
            <fo:block-container top="0cm" left="8.75cm" position="absolute">
                ...
                <fo:block-container height="1cm" width="6cm" top="0cm" left="0cm" position="absolute">
                    <fo:block text-align="start" font-size="9pt" color="#0000ff">
                        <fo:external-graphic src="logo.pdf" content-width="5.95cm" width="100%" scaling="uniform" />
                ...
                <fo:block-container
                    ...
                    <fo:block-container>
                        <fo:block-container left="0cm" top="0mm" width="7cm" position="absolute">
                            <fo:block>Bank: A Bank, A Location, A Country</fo:block>
                            <fo:block>BIC: ABICXXXXXX</fo:block>
                        </fo:block-container>
                        <fo:block-container left="8.75cm" top="0mm" width="7cm" position="absolute">
                            <fo:block>Account Name: A Company Name</fo:block>
                            <fo:block>Account No: ANACCOUTNUMBER0000</fo:block>
                        </fo:block-container>
                    </fo:block-container>
                </fo:block-container>

                <fo:block space-before="5mm" padding="0.6mm" text-align="justify" font-size="8pt" line-height="10pt">
Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aliquam in tempor ligula, et pretium lectus. Cras pellentesque dui non augue hendrerit, sit amet tincidunt elit viverra. Pellentesque gravida odio in mollis tempor. In imperdiet ac ligula eget faucibus. Fusce venenatis tincidunt erat, id auctor ligula luctus et. In risus elit, porttitor vitae sapien ac, dictum porta turpis. Mauris volutpat imperdiet placerat. Phasellus ac tincidunt dolor. Maecenas dignissim sapien et leo venenatis, in semper purus pharetra. Nulla facilisi. Morbi bibendum vestibulum dignissim. Cras euismod condimentum libero sed mollis. Phasellus tincidunt mauris vel porta posuere.
                </fo:block>
            </fo:block-container>
