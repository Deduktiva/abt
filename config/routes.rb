Rails.application.routes.draw do
  ...
  # Everything below is the authenticated app surface (login, invites, WebAuthn,
  # and all CRUD resources). Host-constrain it to the app host so these routes
  # simply do not exist on the customer portal host.
  # ApplicationController#reject_customer_portal_host remains as defense in depth.
