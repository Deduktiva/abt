...
class InvoicesControllerPaidTest < ActionDispatch::IntegrationTest
  ...
  test "show page exposes unpaid status with mark paid form for published invoice" do
    ...
    assert_select ".badge", text: /Unpaid/
  ...
  test "index shows Overdue label with days past due for unpaid invoices" do
    ...
    assert_response :success
    assert_select ".badge", text: "Overdue, 1d"
  end
  ...
  test "index shows Unpaid label with days remaining for invoices not yet past due date" do
    ...
    assert_response :success
    assert_select ".badge", text: "Unpaid, 1d"
    assert_select ".badge", text: /Overdue/, count: 0
  end
  ...
  test "show page shows Overdue label with days past due, header badge stays terse" do
    ...
    assert_response :success
    assert_select ".badge", text: "Overdue, 1d"
    assert_select ".badge", text: "Overdue"
    assert_select ".badge", text: /Unpaid/, count: 0
  end
  ...
  test "unpaid filter includes overdue invoices" do
    ...
    assert_select ".badge", text: "Overdue, 5d"
  end
end
