...
class BusinessTest < ActiveSupport::TestCase
  ...
  test "document_accent_color accepts hex colors of 3, 4, 6, and 8 hex digits" do
    [ "#abc", "#ABCD", "#aabbcc", "#AABBCCDD" ].each do |color|
      company = Business.new(short_name: "X", legal_name: "Y", country_iso2: "NL", document_accent_color: color)
  ...
  test "document_accent_color is optional" do
    company = Business.new(short_name: "X", legal_name: "Y", country_iso2: "NL", document_accent_color: nil)
  ...
  test "get_the_issuer! returns the active issuer" do
    assert_equal businesses(:one), Business.get_the_issuer!
  end
